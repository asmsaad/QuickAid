...
export const NoTicketSelected = (props) => {
    ...
    return (
        <Box sx={{ width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: `calc(100vh - 64px - 20px)`, overflow: "auto" }}>
...
export const LoadingFullScreen = (props) => {
    ...
    return (
        <Box sx={{ width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: `calc(100vh - 64px - 50px - 20px )`, overflow: "auto" }}>
